...
|                   id                 |   name     |                 cover                |
+--------------------------------------+------------+--------------------------------------+
| 123e4567-e89b-12d3-a456-426614174000 | Artist 1   | cover_image_url_1                    |
| 123e4567-e89b-12d3-a456-426614174001 | Artist 2   | cover_image_url_2                    |
+--------------------------------------+------------+--------------------------------------+
...
const GetArtistsFromIDs = `SELECT id, name, cover FROM artists WHERE id = ANY($1::uuid[])`

...
| 123e4567-e89b-12d3-a456-42661420 | 1002         | Playlist   | ID    | ST123        |
| 123e4567-e89b-12d3-a456-42661421 | 1003         | Tab        | ID    | YT123        |
...
It contains the following columns:
  ...
  - 'Type': This denotes the type of the resource (e.g., 'Image', 'ID').

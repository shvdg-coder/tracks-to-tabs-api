...
It contains the following columns:
  ...
  - 'Endpoint': This is the endpoint, which has to be formatted with the corresponding IDs/references, as stored in the 'references' table.
*/
...
const insertEndpointQuery = `
	INSERT INTO "endpoints" (SourceID, Category, Endpoint)
    VALUES ($1, $2, $3)
`
